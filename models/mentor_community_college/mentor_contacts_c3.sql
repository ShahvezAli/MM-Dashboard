with source_data as (
    ...
    from {{ source('mentor_community_college_data_set', 'mentors_c3')}} users
    inner join {{ source('mentor_community_college_data_set', 'friends_c3')}} contacts
...
friend_source_data as (
    ...
    from source_data
    inner join {{ source('mentor_community_college_data_set', 'users_c3')}} friends
