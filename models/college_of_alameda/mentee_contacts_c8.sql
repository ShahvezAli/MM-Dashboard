with source_data as (
    ...
    from {{ source('college_of_alameda_data_set', 'mentees_c8')}} users
    inner join {{ source('college_of_alameda_data_set', 'friends_c8')}} contacts
...
friend_source_data as (
    ...
    from source_data
    inner join {{ source('college_of_alameda_data_set', 'users_c8')}} friends
