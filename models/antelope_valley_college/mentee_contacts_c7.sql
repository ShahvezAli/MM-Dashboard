with source_data as (
    ...
    from {{ source('antelope_valley_college_data_set', 'mentees_c7')}} users
    inner join {{ source('antelope_valley_college_data_set', 'friends_c7')}} contacts
...
friend_source_data as (
    ...
    from source_data
    inner join {{ source('antelope_valley_college_data_set', 'users_c7')}} friends
