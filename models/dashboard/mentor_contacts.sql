with source_data as (
    select users.id, users.first_name, users.last_name, users.email, contacts.friend_id, contacts.friendable_id, contacts.status, contacts.created_at as created_on,
	contacts.updated_at as updated_on
...
friend_source_data as (
    select source_data.id as mentor_id, concat(source_data.first_name, ' ', source_data.last_name) as mentor_name, source_data.email as mentor_email,
